package com.begodya.bbsdkframework.extent;
...
/**
 * Created by wangbei on 6/17/16.
 */
public class SDKLocationUtil {
    private static SDKLocationUtil s_LocationUtil;
    ...
    public static synchronized void initSharedLocation(Context context) {
        if (s_LocationUtil == null) {
            s_LocationUtil = new SDKLocationUtil(context);
        }
    }

    public static synchronized SDKLocationUtil getInstance() {
        return s_LocationUtil;
    }

    public SDKLocationUtil(Context context) {
